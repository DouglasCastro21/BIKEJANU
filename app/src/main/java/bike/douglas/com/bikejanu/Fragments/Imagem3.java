        ...
        DatabaseReference reference = databaseReference.child("TodasBikes").child("000");
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot !=null) {
                    ...
                    if (dados.getFotoBikeUrl3().equals("")){

                        Glide.with(Imagem3.this).load("https://firebasestorage.googleapis.com/v0/b/bikejanu-62aa9.appspot.com/o/camera.png?alt=media&token=9c8f88d1-6264-4c90-baf4-cacc6b06a181").into(imagemBike);
